...
class PropositionTests(LibTestCase, unittest.TestCase):
    ...
    def test_understanding_proposition_getters(self):
        ...
        self.assertEqual(speaker.USR, und.speaker)
        self.assertEqual(proposition, und.content)
...
class ServiceResultPropositionTests(LibTestCase):
    ...
    def test_getters(self):
        self.assertEqual(self.action, self.proposition.service_action)
        self.assertEqual(self.arguments, self.proposition.arguments)
        self.assertEqual("mock_perform_result", self.proposition.result)
...
class PropositionSetTests(LibTestCase):
    ...
    def test_get_polarity(self):
        self.assertEqual(Polarity.POS, self.positive_prop_set.polarity)
        self.assertEqual(Polarity.NEG, self.negative_prop_set.polarity)
...
class ServiceActionTerminatedTests(LibTestCase):
    ...
    def test_done_proposition_contains_action(self):
        self.assertEqual(self.service_action, self.done.service_action)
...
class RejectionTests(LibTestCase):
    ...
    def test_creation_with_reason(self):
        ...
        self.assertEqual(self.rejected_combination, rejected.rejected_combination)
    ...
    def test_get_rejected_combination(self):
        self.assertEqual(self.rejected_combination, self.rejected.rejected_combination)
...
class PrereportPropositionTests(LibTestCase):
    ...
    def test_get_service_action(self):
        self.assertEqual(self.service_action, self.prereport.service_action)

    def test_get_arguments(self):
        self.assertEqual(self.empty_arguments, self.prereport.arguments)
...
class PreconfirmationTests(LibTestCase):
    ...
    def test_get_service_action(self):
        self.assertEqual(self.service_action, self.preconfirmation.service_action)

    def test_get_arguments(self):
        self.assertEqual(self.arguments, self.preconfirmation.arguments)
...
class ResolvednessPropositionTests(LibTestCase):
    ...
    def test_get_issue(self):
        self.assertEqual(self.issue, self.proposition.issue)
...
class PredicatePropositionTests(LibTestCase):
    ...
    def test_predicate(self):
        self.assertEqual("dest_city", self.proposition_dest_city_paris.predicate.name)
