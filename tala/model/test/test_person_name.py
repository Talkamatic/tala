...
class PersonNameTestCase(unittest.TestCase):
    def test_unicode(self):
        self.when_get_unicode_string(PersonName(u"Åsa"))
        self.then_result_is(u'person_name(Åsa)')

    def when_get_unicode_string(self, person_name):
        self._actual_result = unicode(person_name)

    def then_result_is(self, expected_result):
        self.assertEquals(expected_result, self._actual_result)

    def test_repr(self):
        self.when_get_repr(PersonName(u"Åsa"))
        self.then_result_is("PersonName(%r)" % u"Åsa")
    ...
    def test_str_does_not_crash_with_unicode_string(self):
        self.when_get_str_string(PersonName(u"Åsa"))
