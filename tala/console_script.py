...
def add_build_subparser(subparsers):
    ...
    parser.add_argument("--rasa-config", dest="rasa_config", default=None,
...
def add_create_ddd_subparser(subparsers):
    ...
    parser.add_argument("--target-dir", default=".", metavar="DIR",
...
def add_create_backend_config_subparser(subparsers):
    ...
    parser.add_argument("--filename", default=BackendConfig.default_name(), metavar="NAME",
...
def add_create_ddd_config_subparser(subparsers):
    ...
    parser.add_argument("--filename", default=DddConfig.default_name(), metavar="NAME",
...
def add_create_rasa_config_subparser(subparsers):
    ...
    parser.add_argument("--filename", default=RasaConfig.default_name(), metavar="NAME",
