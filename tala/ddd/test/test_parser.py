...
class ParserTests(unittest.TestCase):
    ...
    def test_report_move_with_specific_action_done(self):
        ...
        self._then_result_is(ReportMove(ActionStatusProposition(self.buy_action, Done())))
